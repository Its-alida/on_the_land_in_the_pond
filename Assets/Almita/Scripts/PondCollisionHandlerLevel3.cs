...
public class PondCollisionHandlerLevel3 : MonoBehaviour
{
    ...
    private IEnumerator GenerateCommands()
    {
        ...
        while (totalTime < timerDuration)
        {
            ...
            yield return new WaitForSeconds(5f); // Wait for 3 seconds to check player's position
            ...
            totalTime += 8f; // Increment total time by 6 seconds
        }
    }
