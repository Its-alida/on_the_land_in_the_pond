...
public class PondCollisionHandlerLevel2 : MonoBehaviour
{
    ...
    private IEnumerator GenerateCommands()
    {
        ...
        while (totalTime < 90f)
        {
            ...
            yield return new WaitForSeconds(3f); // Wait for 5 seconds to check player's position
            ...
            totalTime += 6f; // Updated to reflect total time spent in each loop iteration
        }
    }
